  ...
  return (
    <div>
      <div className="flex items-center justify-center min-h-screen   ">
        ...
        <div className=" bg-white bg-center pl-7 pr-7 pt-3 pb-2 w-[500px] rounded-lg mt-6 relative ">
          <h2 className="text-2xl font-bold text-center text-teal-500 mt-3" >Create Account</h2>
          ...
          <form className="" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 text-sm mt-3 text-gray-700">
                I agree to the{" "}
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 mt-3 text-white bg-teal-500 rounded-md"
            >
